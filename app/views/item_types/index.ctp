...
?>
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			<?php echo $html->link(__('View', true), array('action'=>'view', $itemType['ItemType']['id'])); ?>
			<?php echo $html->link(__('Edit', true), array('action'=>'edit', $itemType['ItemType']['id'])); ?>
			<?php echo $html->link(__('Delete', true), array('action'=>'delete', $itemType['ItemType']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $itemType['ItemType']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
</table>
